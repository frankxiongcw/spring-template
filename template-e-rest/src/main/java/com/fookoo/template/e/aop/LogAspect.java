package com.fookoo.template.e.aop;
...
public class LogAspect {
    ...
    @Pointcut("execution(* com.fookoo.template.e.controller..*.*(..))")
            ...
            for (Object object : args) {
                if (object != null) {
                    ...
                    if (object instanceof ServletRequest
                            ...
                            || object instanceof MultipartFile || object instanceof BusinessCardDetailParam) {
                        continue;
                    }
